...
const UserReceipt = () => {
  return (
    <div className="mx-auto">
      {/* LEFT */}
      <form className="mt-8 p-2 md:p-10 bg-slate-50 w-[380px] sm:w-[800px] md:max-w-[800px] flex flex-col justify-center">
        ...
        <div className="bg-white">
          ...
          <div className="flex justify-start space-x-4">
            ...
            >
              ...
              <p className="text-lg md:text-xl">Your money is on its way</p>
            </div>
          </div>
          ...
          <div className="mt-6 flex justify-start space-x-4">
            <div type="text" className="bg-transparent flex flex-col">
              ...
              <p className="mt-4 mb-4 text-sm md:text-md">
                You may want to print it for your records.
              </p>
              {/* WUDB UPSELL TO REDIRECT MTCN */}
              <div className="p-2 border-2 border-red-500">
                <h1 className="mt-2 mb-2 text-sm md:text-xl">
                  <span className="font-bold">Your receiver</span> has been
                  notified on +40 77777777 that your 300 EUR is available for
                  pickup. She can now decide to access it in the wallet or cash
              ...
              <div className="p-2">
                ...
                <p>
                  <span className="font-bold text-sm md:text-md">Denisa</span>{" "}
                  will need the following at a WU agent location:
                </p>
                <ul className="mt-4 mb-4 indent-8 text-sm md:text-md">
          ...
          {/* MyWU BOX */}
          <div className="mt-6 mb-6 text-sm md:text-md">
            {/* ROW 1 */}
            <div className="flex justify-start space-x-4">
          ...
          {/* ROW 3 */}
          <div className="mt-6 flex justify-start space-x-4 text-sm md:text-md">
            <div
              type="text"
              className="bg-transparent flex flex-col outline-none w-[400px]"
            >
